...
export class Transaction {
  ...
  public getRemainingAmounts(): Amounts {
    let remaining = Amounts.fromAmounts(this.requestedAmounts);
    for (const transactionResponse of this.transactionResponses) {
  ...
  public getProcessedAmounts(): Amounts {
    let processed = Amounts.from(0, this.requestedAmounts.currency);
    for (const transactionResponse of this.transactionResponses) {
